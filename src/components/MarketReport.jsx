const marketReportMeta={dataDate:'2026/08/20',updateNote:'資料日期 2026/08/20 收盤・大盤／類股／上市櫃法人已更新；美股仍為 8/19 收盤（美東尚未開盤）'};
...
const globalMarkets=[{id:'dow',label:'道瓊工業・2026-08-19',value:'53,463.05',change:'+0.22%',direction:'up'},{id:'sp500',label:'S&P 500・2026-08-19',value:'7,707.98',change:'+0.21%',direction:'up'},{id:'nasdaq',label:'Nasdaq・2026-08-19',value:'26,331.09',change:'+0.16%',direction:'up'},{id:'sox',label:'費城半導體・2026-08-19',value:'11,738.23',change:'-2.12%',direction:'down'},{id:'nikkei',label:'日經225・2026-08-20',value:'66,216.79',change:'+1.36%',direction:'up'},{id:'kospi',label:'KOSPI・2026-08-20',value:'6,852.58',change:'+5.89%',direction:'up'},{id:'usd',label:'美元指數・2026-08-20',value:'98.70',change:'-0.13%',direction:'down'},{id:'usdtwd',label:'美元/新台幣',value:'31.89',change:'+0.03%',direction:'up'}];
