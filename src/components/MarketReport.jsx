const marketReportMeta={dataDate:'2026/08/19',updateNote:'資料日期 2026/08/19 收盤・大盤已更新；法人表仍為 8/17 參考'};
...
const globalMarkets=[{id:'dow',label:'道瓊工業・2026-08-18',value:'53,343.40',change:'-0.22%',direction:'down'},{id:'sp500',label:'S&P 500・2026-08-18',value:'7,691.76',change:'-0.69%',direction:'down'},{id:'nasdaq',label:'Nasdaq・2026-08-18',value:'26,289.71',change:'-1.33%',direction:'down'},{id:'sox',label:'費城半導體・2026-08-18',value:'11,992.46',change:'-4.98%',direction:'down'},{id:'nikkei',label:'日經225・2026-08-18',value:'68,936.33',change:'+0.32%',direction:'up'},{id:'kospi',label:'KOSPI・2026-08-18',value:'7,192.28',change:'+3.07%',direction:'up'},{id:'usd',label:'美元指數 DY・2026-08-18',value:'99.56',change:'-0.12%',direction:'down'},{id:'usdtwd',label:'美元/新台幣・2026-08-18',value:'31.8',change:'-0.61%',direction:'down'}];
const technicalOverview={note:'依 2026-08-19 收盤後綜合評估（技術燈號暫沿用前次）',columns:[
