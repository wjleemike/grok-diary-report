...
const technicalOverview={note:'依 2026-08-18 技術分析綜合評估',columns:[{id:'add',title:'加碼 (1)',color:'green',items:[{name:'潤隆',score:'3'}]},{id:'hold',title:'續抱 (13)',color:'teal',items:[{name:'台積電',score:'2.0'},{name:'長榮',score:'1.9'},{name:'王品',score:'1.9'},{name:'材料-KY',score:'1.7'},{name:'廣達',score:'1.6'},{name:'玉山金',score:'1.4'},{name:'智原',score:'1.3'},{name:'奕力-KY',score:'1.3'},{name:'遠東銀',score:'1'},{name:'統一台灣高息動能',score:'1'},{name:'凱基金',score:'1'},{name:'技嘉',score:'1'},{name:'大華優利高填息',score:'1'}]},{id:'watch',title:'觀望 (17)',color:'yellow',items:[{name:'中鴻',score:'0.9'},{name:'三商壽',score:'0.7'},{name:'技宸',score:'0.4'},{name:'華票',score:'0.3'},{name:'群益台灣精選高息',score:'0.3'},{name:'復華台灣科技優息',score:'0'},{name:'元大台灣價值高息',score:'-0.1'},{name:'英業達',score:'-0.1'},{name:'中信金',score:'-0.1'},{name:'海悅',score:'-0.3'},{name:'原相',score:'-0.3'},{name:'主動野村台灣優選',score:'-0.3'},{name:'中信關鍵半導體',score:'-0.3'},{name:'群益ESG投等債20+',score:'-0.7'},{name:'群益證',score:'-0.8'},{name:'中信中國高股息',score:'-1'}]},{id:'reduce',title:'減碼 (1)',color:'red',items:[{name:'聯發科',score:'-2.3'}]}]};
